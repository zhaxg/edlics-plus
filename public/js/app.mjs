...
api('GET', '/api/info').then(data => {
  if (data && data.user) {
    ...
    document.getElementById('statusLeft').innerHTML = 'Edlics-plus <a href="https://github.com/zhaxg/edlics-plus" target="_blank" style="color:inherit;text-decoration:none;">v' + data.version + '</a> by <a href="https://github.com/zhaxg" target="_blank" style="color:inherit;text-decoration:none;">zhaxg</a>';
